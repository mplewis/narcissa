...
def scrape_strava():
    ...
    # Strava auth callbacks will hit this port. Change it if you need to avoid
    ...
    def get_new_token():
        authorize_url = client.authorization_url(
            client_id=CLIENT_ID,
            redirect_uri='http://localhost:%s' % CALLBACK_PORT
        )
    ...
    def auth_listener(environ, start_response):
        ...
        return ['Got your Strava authorization! You can close this window now.'
                .encode('utf-8')]
